...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    const loadAlertSettings = async () => {
      try {
        const res = await apiClient.getAlertSettings()
        if (res.success && res.data) {
  ...
  const handleConnectDeriv = async () => {
    ...
    // Simulate connection - in real implementation, this would call an API
    setTimeout(() => {
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="p-6 rounded-xl border-2 border-dashed hover:border-primary/50 transition-colors">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center text-white font-bold text-lg">
                        D
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="space-y-4">
                              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                                ...
                                <p className="text-xs text-green-600/80 mt-1">
                                  TradeGuard AI can now sync your trading data automatically
                                </p>
                              </div>
                              ...
                              <div className="flex gap-2">
                                ...
                                <Button variant="destructive" onClick={handleDisconnectDeriv}>
                                  Disconnect
                                </Button>
                              </div>
                            </div>
